...
if __name__ == "__main__":
    grammar = get_grammar("grammarrules")
    ...
    string = None
    try:
        string = "".join(get_tokens("wrong"))
    except:
        pass
    if string!=None:
        print("the string to be parsed is :- ", string)
        print("b stands for begin")
        print("f stands for for")
        print("i stands for int")
        print("m stands for main")
        print("y stands for end")
        print("z stands for End")
        print("b stands for begin")
        print("v stands for identifier")
        print("o stands for operators")
        print("d stands for digit")
        print("e stands for expr")
    try:
